@extends('master')
  ...
  @endphp
      ...
      <div class="container px-3" style="display:flex;justify-content:center;margin:0 auto;">
        ...
        <div id="loyaltyCard">
          <div class="cardContent">  
            ...
            <img src="{{URL::asset('/images/logo.jpg')}}" class="logo" style="grid-erea:logo;justify-self:end;border-radius:50%;width:50px;">
            @php
            $generatorPNG = new Picqer\Barcode\BarcodeGeneratorPNG();
            $code = Auth::user()['name'].'-'.Auth::id();
          @endphp
            
          <img class="barcode" style="grid-erea:barcode;grid-column: span 3;margin:0 auto;min-height:50px;" width="70%" src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode($code, $generatorPNG::TYPE_CODE_128)) }}">
          </div>
    ...
    <div style="text-align:center;">
      <h1 class="point">i tuoi ultimi punti ricevuti</h1>
      <br>
