...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal gradient" style="font-family: 'Source Sans Pro', sans-serif;color:#d18d25;">
    <!--Nav-->
    ...
    <div class="pt-24" >
      <div class="container px-3">
        <!--Left Col-->
        <div id="loyaltyCard" style="margin:0 auto;border-radius:10px;padding:10px;">
          <div class="cardContent">  
            <div class="title" style="grid-erea:title;justify-self:start;">
              ...
              <strong style="margin-left:10px;color:#923116;">Gnameat</strong>
            </div>
            
            <strong class="name" style="grid-erea:name;justify-self:end;color:#923116;">{{strtoupper(Auth::user()['name']).' '.strtoupper(Auth::user()['lastname'])}}</strong>
          
            <strong class="point">
              i tuoi punti: <span style="color:#923116">125</span>
            </strong>
            <img src="{{URL::asset('/images/logo.jpg')}}" class="logo" style="grid-erea:logo;justify-self:center;border-radius:50%;width:50px;">
          </div>
          <div  >
          @php
          ...
          <img style="margin:0 auto;min-height:50px;" width="70%" src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode($code, $generatorPNG::TYPE_CODE_128)) }}">
    ...
    <footer class="bg-white" style="position: absolute;bottom:0;width:100%">
