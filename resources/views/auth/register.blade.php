...
<html lang="en">
    ...
    <body>
        <div class="flex items-center justify-center min-h-screen" style="background-image:linear-gradient(90deg,#d18d25 0%,#923116 100%)">
            <div class="px-8 py-6 mx-4 mt-4 text-left shadow-lg md:w-1/2 lg:w-1/2sm:w-1/2" style="background-color:white;">
                <div class="flex justify-center">
                    <a href="{{route('/')}}">
                        <img src="{{URL::asset('/images/register-logo.jpg')}}" width="50%" style="margin:0 auto;">
                    </a>
                </div>
