  ...
  <body class="leading-normal tracking-normal gradient" style="font-family: 'Source Sans Pro', sans-serif;color:#d18d25;">
    ...
    <footer class="bg-white">
      <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6 content-center items-center justify-between">
          <div class="footer-logo flex-1 mb-6 text-black">
